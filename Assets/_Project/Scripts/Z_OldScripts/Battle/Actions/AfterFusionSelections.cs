...
//             if(_resultCard is CardMonster){
//                 //Anima            
//                 if(BattleManager.Instance.AIStateManager.AfterFusionSelector.AnimaSelection() == 0){
//                     FirstAnimaSelected();
//                 }else{
//                     SecondAnimaSelected();
//                 }
...
//                 //Monster Mode
//                 if(BattleManager.Instance.AIStateManager.AfterFusionSelector.MonsterModeSelection(_resultCard as CardMonster) == 0){
//                     AttackModeSelected();
//                 }else{
//                     DefenseModeSelected();
//                 }
...
//                 //Not Fusioned Card
//             if(!_resultCard.IsFusioned()){
//                 if(BattleManager.Instance.AIStateManager.AfterFusionSelector.FaceSelection(_resultCard) == 0){
//                     FaceUpSelected();
//                 }else{
//                     FaceDownSelected();
//                 }
...
//         AbstractBattleState.OnEndState?.Invoke(BattleManager.Instance.BoardPlaceSelectionPhase);
//     }
// }