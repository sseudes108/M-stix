...
public abstract class AIArchetype{
    ...
    public abstract int SelectMonsterPlaceOnBoard(List<Transform> monsterBoardPlaces);

    public void SetMonstersList(List<CardMonster> lvl1MonstersList,List<CardMonster> lvl2MonstersList, List<CardMonster> lvl3MonstersList, List<CardMonster> lvl4MonstersList, List<CardMonster> lvl5MonstersList, List<CardMonster> lvl6MonstersList, List<CardMonster> lvl7MonstersList){
